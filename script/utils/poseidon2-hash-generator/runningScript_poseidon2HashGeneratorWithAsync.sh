...
npx tsx script/utils/poseidon2-hash-generator/poseidon2HashGeneratorWithAsync.ts  # Success
#npx ts-node script/utils/poseidon2-hash-generator/poseidon2HashGeneratorWithAsync.ts
