...
contract IPNFTOnEDUChainTestnetTest is Test {
    ...
    function setUp() public {
        ...
        address IPNFT_FACTORY = vm.envAddress("IPNFT_FACTORY_ON_EDU_CHAIN_TESTNET");
        ...
        ipNFTFactory = IPNFTFactory(IPNFT_FACTORY); /// @dev - Deploy the IPNFTFactory contract
